...
export const defaultSettings: AppSettings = {
  ...
  storeInfo: {
    ...
    aboutTitle: 'About Us',
    aboutText: 'Leading wholesaler of premium apparel.',
    aboutHeading: 'Crafting quality apparel with exceptional attention to detail.',
    aboutParagraph: 'We are a dedicated B2B wholesale partner serving customers across India. Our focus is purely on delivering premium fabrics, durable stitching, and modern fits that ensure high sell-through rates for your stores.',
    aboutButtonText: 'Explore Catalog',
    ...
    whyChooseTitle: 'Why Customers Choose Us',
    whyChooseSubtitle: 'Our Advantage',
    catalogTitle: 'Explore Categories',
    catalogSubtitle: 'Our Catalog',
    ctaTitle: 'Ready to upgrade your inventory?',
    ctaSubtitle: 'Join hundreds of premium customers stocking quality wear. Register today to access exclusive wholesale pricing.',
    ctaButtonText: 'Create Account',
    ctaButtonLink: '/login',
    footerTitle: 'Wholesale Apparel',
    footerText: '',
  },
  homepage: {
    ...
    ctaText: 'Ready to upgrade your inventory?',
    promoBanners: [
      {
        id: '1',
