...
export const defaultSettings: AppSettings = {
  ...
  storeInfo: {
    ...
    aboutParagraph: 'We are a dedicated B2B wholesale partner serving retailers across India. Our focus is purely on delivering premium fabrics, durable stitching, and modern fits that ensure high sell-through rates for your stores.',
    ...
    ctaSubtitle: 'Join hundreds of premium retailers stocking quality wear. Register today to access exclusive wholesale pricing.',
